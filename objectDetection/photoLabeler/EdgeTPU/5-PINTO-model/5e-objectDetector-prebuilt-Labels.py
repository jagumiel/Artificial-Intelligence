...
#interpreter = tflite.Interpreter('5e_mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite')
interpreter = edgetpu.make_interpreter('5e_mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite')
...
img = Image.open('out7.jpeg').resize((300, 300))
...
cv2.imwrite("out7-labeled.jpeg", np.array(cv_img, dtype = np.uint8))
